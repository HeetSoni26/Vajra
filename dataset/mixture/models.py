...
class SamplingStrategy(BaseModel):
    ...
    """
    type: str = Field(..., description="The sampling strategy type (e.g., fixed, temperature, dynamic).")
...
class DatasetMixtureEntry(BaseModel):
    ...
    sampling_strategy: Optional[SamplingStrategy] = Field(default=None, description="Sampling strategy interface.")
    ...
    is_enabled: bool = Field(default=True, description="Whether this dataset is actively included in the mixture.")
