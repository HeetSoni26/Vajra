...
def cmd_train(args):
    ...
    sample = ["Hello world, this is Vajra.", "Vajra is a foundation model.", "The tokenizer is training."]
...
def cmd_benchmark(args):
    ...
    texts = ["This is a test of the vajra encoding speed.", "It should be extremely fast because it uses rust."] * 1000
