...
class EvaluationPipeline:
    ...
    def evaluate_benchmark(self, benchmark_name: str, dataset: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    def run_suite(self, benchmarks: List[str], dataset_mocks: Dict[str, List[Dict[str, Any]]]) -> Dict[str, Dict[str, Any]]:
