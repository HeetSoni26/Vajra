...
class ReleasePackager:
    ...
    def create_package(self, model: Any, config: Dict[str, Any], tokenizer: Any = None, metrics: Dict[str, Any] = None):
        ...
        (self.output_dir / "CHANGELOG.md").write_text("# Changelog\n\n## 1.0.0\n- Initial Release of Vajra-370M")
    ...
    def verify_package(self) -> bool:
        ...
        has_weights = (self.output_dir / "model.safetensors").exists() or (self.output_dir / "pytorch_model.bin").exists()
